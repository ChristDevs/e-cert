						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="card">
									...
									<form class="form" role="form" action="{{route('users.update', $user->id)}}" method="post">
										{{method_field('patch')}}
                                        {{csrf_field()}}
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-group floating-label {{error($errors, 'name')}}">
																<input value="{{old('name', $user->name)}}" type="text" class="form-control" id="firstname" name="name">
                                                    ...
                                                    <div class="row">
														<div class="col-md-6">
															<div class="form-group floating-label {{error($errors, 'phone_number')}}">
																<input value="{{old('phone_number', $user->phone_number)}}" type="text" class="form-control" id="company" name="phone_number">
